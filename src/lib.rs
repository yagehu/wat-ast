...
pub use expression::{
    fold, i32_const, AsAtoms, Block, Br, BrIf, BrTable, Call, Drop, Expression,
    GlobalGet, GlobalSet, I32Add, I32Const, I32Eq, I32Eqz, I32GtU, I32Ne,
    I32RemU, I32Sub, I64Const, If, Instruction, Local, LocalGet, LocalSet,
    LocalTee, Loop, Then,
};
